...
namespace Store.Tests.Handlers
{
    ...
    public class OrderHandlerTests
    {
        ...
        {
            var commandItens = new List<CreateOrderItemCommand>();
            commandItens.Add(new CreateOrderItemCommand(Guid.NewGuid(), 1));

            var command = new CreateOrderCommand("12345678911", "15040190", "123", commandItens);

            var handler = new OrderHandler(_customerRepository, _deliveryFeeRepository, _discountRepository, _orderRepository, _productRepository);
